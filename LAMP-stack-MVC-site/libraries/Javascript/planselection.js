...
// ten through fifteen
	...
	//3d tvs
		...
		*/
		...
		var total = (a8 + b8 + c8 + d8 + e8 + f8 + g8 + h8 + i8 + j8 + k8 + l8 + m8 + n8 + o8 + p8 + q8 + r8 + s8 + t8);
...
// face	
		...
		alexander[11] += 1;
				...
				camera.src="../styles_styles/images/unselected/facialrecog.jpg";
				sidepanel.src="../styles_styles/images/texts/face.jpg";
				selected[selected.indexOf("camera")] = "";
				duplex2();
